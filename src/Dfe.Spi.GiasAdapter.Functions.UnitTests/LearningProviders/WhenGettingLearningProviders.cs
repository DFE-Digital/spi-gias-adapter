...
namespace Dfe.Spi.GiasAdapter.Functions.UnitTests.LearningProviders
{
    public class WhenGettingLearningProviders
    {
        ...
        private HttpRequest GetHttpRequest(LearningProvider[] providers, string[] fields = null, bool? live = null)
        {
            var identifiers = providers.Select(p => p.Ukprn.ToString()).ToArray();
            return GetHttpRequest(identifiers, fields, live);
        }

        private HttpRequest GetHttpRequest(string[] identifiers = null, string[] fields = null, bool? live = null)
        {
            return GetHttpRequestFromGetLearningProvidersRequest(
                GetDefaultGetLearningProvidersRequest(identifiers, fields, live));
        }
        ...
        private GetLearningProvidersRequest GetDefaultGetLearningProvidersRequest(string[] identifiers = null, string[] fields = null, bool? live = null)
        {
