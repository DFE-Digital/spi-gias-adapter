...
namespace Dfe.Spi.GiasAdapter.Functions.UnitTests.LearningProviders
{
    public class WhenGettingLearningProviders
    {
        ...
        private HttpRequest GetHttpRequest(LearningProvider[] providers, string[] fields = null, bool? live = null, DateTime? pointInTime = null)
        {
            var identifiers = providers.Select(p => p.Ukprn.ToString()).ToArray();
            return GetHttpRequest(identifiers, fields, live, pointInTime);
        }

        private HttpRequest GetHttpRequest(string[] identifiers = null, string[] fields = null, bool? live = null, DateTime? pointInTime = null)
        {
            return GetHttpRequestFromGetLearningProvidersRequest(
                GetDefaultGetLearningProvidersRequest(identifiers, fields, live, pointInTime));
        }
        ...
        private GetLearningProvidersRequest GetDefaultGetLearningProvidersRequest(string[] identifiers = null, string[] fields = null, bool? live = null, DateTime? pointInTime = null)
        {
            return new GetLearningProvidersRequest
            {
                Identifiers = identifiers ?? new[] {"12345678"},
                Fields = fields,
                Live = live.HasValue && live.Value,
