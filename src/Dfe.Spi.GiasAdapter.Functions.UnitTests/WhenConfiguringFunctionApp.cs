...
namespace Dfe.Spi.GiasAdapter.Functions.UnitTests
{
    public class WhenConfiguringFunctionApp
    {
        ...
        private IConfigurationRoot GetTestConfiguration()
        {
            return new ConfigurationBuilder()
                .AddInMemoryCollection(new[]
                {
                    ...
                    new KeyValuePair<string, string>("Cache:StateTableName", "unit-tests-state"),
                    ...
                    new KeyValuePair<string, string>("Cache:TidyCacheSchedule", "0 0 5 * * *"),
                    new KeyValuePair<string, string>("Cache:NumberOfDaysToRetainStagingData", "1"),
        ...
        private Type[] GetFunctions()
        {
            return new[]
            {
                typeof(ProcessStagingLocalAuthority),
                typeof(ProcessStagingGroup),
